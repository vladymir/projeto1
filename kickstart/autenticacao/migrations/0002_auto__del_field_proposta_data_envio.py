...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Proposta.data_envio'
        raise RuntimeError("Cannot reverse this migration. 'Proposta.data_envio' and its values cannot be restored.")
